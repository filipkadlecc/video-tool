...
const HEAD_TOP = { cta: 671.5, claim: 747.5 };
const BUTTON = { y: 1094.5, w: 384, h: 110.4 };
...
export default function ShortEndCard() {
  ...
  const top = Y || (isClaim ? HEAD_TOP.claim : HEAD_TOP.cta);
    ...
    <AbsoluteFill>
      ...
      <div style={plane.outer}>
        <div style={plane.inner}>
          ...
          <div style={{
            position: "absolute", top, left: VERTICAL_CENTRE_X - 619 / 2, width: 619,
          ...
          <div style={{
            position: "absolute", top: BUTTON.y, left: VERTICAL_CENTRE_X - BUTTON.w / 2,
