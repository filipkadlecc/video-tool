...
BRAND.colors.orangeTint  // rgba(248,102,6,0.16) — highlight fills
\`\`\`
...
- Orange is for emphasis — use it sparingly and on purpose:
  - One highlighted phrase per headline (wrap in an inline pill with \`orangeTint\` bg + 1px \`orange\` bottom border, ~8px h-padding, 6px radius)
